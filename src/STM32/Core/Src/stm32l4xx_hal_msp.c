...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PA0     ------> ADC1_IN5
    */
    HAL_GPIO_DeInit(MOISTURE_SENSOR_INPUT_GPIO_Port, MOISTURE_SENSOR_INPUT_Pin);
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  if(hi2c->Instance==I2C1)
  {
    ...
    PB9     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(I2C1_SCL_CURRENT_GPIO_Port, I2C1_SCL_CURRENT_Pin);

    HAL_GPIO_DeInit(I2C1_SDA_CURRENT_GPIO_Port, I2C1_SDA_CURRENT_Pin);
